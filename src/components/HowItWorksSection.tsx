...
const steps = [
  { num: 1, title: "Upload Your Resume", desc: "Upload your resume (PDF/DOCX) with a job description, specific role, or for a general ATS scan.", tags: ["With JD", "With Role", "General Scan"], accent: "#8b5cf6" },
  { num: 2, title: "ATS Score & Suggestions", desc: "AI analyzes your resume against ATS systems — detailed score breakdown for Format, Skills, Experience, Keywords.", tags: ["ATS Score", "Breakdown", "Keywords"], accent: "#3b82f6" },
  { num: 3, title: "AI Upgrades Your Resume", desc: "JOBRA AI rewrites your resume — adding quantified achievements, industry keywords, and proper ATS formatting.", tags: ["AI Rewrite", "Keywords", "Achievements"], accent: "#6366f1" },
  { num: 4, title: "Choose a Template", desc: "Pick from 22 professional resume templates. Your AI-improved data is auto-filled. Export as PDF.", tags: ["22 Templates", "Auto-Fill", "PDF Export"], accent: "#06b6d4" },
  { num: 5, title: "Smart Job Matching", desc: "JOBRA finds matching job listings with compatibility scores based on your optimized resume.", tags: ["Job Matches", "Compatibility", "Apply Direct"], accent: "#f59e0b" },
  { num: 6, title: "AI Mock Interview", desc: "Practice with our AI interviewer — get role-specific questions and real-time scoring.", tags: ["AI Interviewer", "Real-Time Scoring"], accent: "#f43f5e" },
  { num: 7, title: "Expert Mentorship", desc: "Connect with industry professionals for 1-on-1 career coaching and personalized guidance.", tags: ["1-on-1 Sessions", "Industry Pros"], accent: "#a855f7" },
];
