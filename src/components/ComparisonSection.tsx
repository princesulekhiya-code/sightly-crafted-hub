        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="rounded-2xl border border-border/50 overflow-hidden bg-card/30 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-5 border-b border-border/30">
              <div className="p-4 md:p-5 text-xs text-muted-foreground/50 uppercase tracking-widest font-medium">Features</div>
              {competitors.map((c, i) => (
                <div
                  key={i}
                  className={`p-4 md:p-5 text-center text-sm font-semibold ${
            ...
            {features.map((feat, fi) => (
              ...
              >
                <div className="p-4 md:p-5 text-sm text-muted-foreground/80">{feat}</div>
